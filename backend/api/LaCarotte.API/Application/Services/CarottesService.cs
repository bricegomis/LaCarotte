...
public class CarotteService(ILogger<ICarotteService> logger, ICarotteRepository  repository)
    : ICarotteService //: BackgroundService
{
    // private const string Login = "Test";
    // private readonly IMongoDBService _mongoDBService = mongoDBService;
    // private readonly IDateTimeProvider _dateTimeProvider = dateTimeProvider;
    // private readonly ILogger<ICarotteService> _logger = logger;
    ...
    // }
    public Task Create(CarotteCreateDto carotte)
    {
        throw new NotImplementedException();
        // return carotteRepository.AddAsync()
        // var product = _mapper.ToDocument(dto, profileId);
        // await repository.AddAsync(product);
        // return product;
    }

    public async Task<CarotteDto> Get(string id)
    {
        throw new NotImplementedException();
    }

    public async Task<List<CarotteDto>> List()
    {
        throw new NotImplementedException();
    }

    public async Task Update(CarotteDto carotte)
    {
        throw new NotImplementedException();
    }
